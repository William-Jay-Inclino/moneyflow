...
export const IncomeScreen = ({ navigation }: { navigation: any }) => {
    ...
    const handleEditIncome = useCallback((income: any) => {
        try {
            ...
            const categoryObj = categories.find(cat => cat.id === income.categoryId || cat.id.toString() === income.categoryId?.toString());
            ...
            <View style={styles.container}>
                ...
                <View style={{backgroundColor: '#fef3c7', padding: 8, borderRadius: 8, margin: 16}}>
                    <Text style={{color: '#b45309', fontSize: 13, textAlign: 'center', fontWeight: '500'}}>
                        You are offline. Income cannot be added or viewed. Please reconnect to continue.
                    </Text>
                </View>
            </View>
        );
